...
const ContactSection = ({ sectionTitleStyle, conactInfoStyles }) => {
    ...
    query ContactInfoQuery {
        landingJson(id: {eq: "landing-contact-section"}) {
            title
            subtitle
            contact_info{
              title
                ...
                <Row>
                    ...
                    <Col lg={5} ml="auto">
                        <ContactInfoBox>
                            ...
                            <Heading {...phoneStyle}>
                                <Anchor target="__blank" path="https://api.whatsapp.com/send?phone=573004859118"  {...phoneAnchorStyle}>{conactInfo.phone}</Anchor>
                            </Heading>
