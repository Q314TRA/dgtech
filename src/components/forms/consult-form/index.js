                ...
                <Col lg={12}>
                    <FormGroup mb="20px">
                        ...
                        >
                            ...
                            <option value="Información sobre nuestra empresa">Información sobre nuestra empresa</option>
                            <option value="Información sobre nuestros servicios">Información sobre nuestros servicios</option>
                            <option value="Consulta con un experto">Consulta con un experto</option>
